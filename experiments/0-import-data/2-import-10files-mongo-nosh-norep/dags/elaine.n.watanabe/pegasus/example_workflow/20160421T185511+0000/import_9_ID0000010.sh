...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::import_9:1.0 -N ID0000010 -R condorpool  -L example_workflow -T 2016-04-21T18:55:08+00:00 ./example_workflow-import_9-1.0 
job_ec=$?
set -e
