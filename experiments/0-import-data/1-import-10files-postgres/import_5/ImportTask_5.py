...
import ConfigCSVGZ_ImportTask_5
import ConfigDB_ImportTask_5

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_5)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_5)
