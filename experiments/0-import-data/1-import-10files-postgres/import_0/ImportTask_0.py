...
import ConfigCSVGZ_ImportTask_0
import ConfigDB_ImportTask_0

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_0)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_0)
