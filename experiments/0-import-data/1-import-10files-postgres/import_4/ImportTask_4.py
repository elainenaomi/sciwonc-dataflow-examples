...
import ConfigCSVGZ_ImportTask_4
import ConfigDB_ImportTask_4

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_4)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_4)
