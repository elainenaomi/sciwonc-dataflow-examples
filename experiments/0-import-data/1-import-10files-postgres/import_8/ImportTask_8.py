...
import ConfigCSVGZ_ImportTask_8
import ConfigDB_ImportTask_8

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_8)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_8)
