...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::import_8:1.0 -N ID0000009 -R condorpool  -L example_workflow -T 2016-04-24T23:11:45+00:00 ./example_workflow-import_8-1.0 
job_ec=$?
set -e
