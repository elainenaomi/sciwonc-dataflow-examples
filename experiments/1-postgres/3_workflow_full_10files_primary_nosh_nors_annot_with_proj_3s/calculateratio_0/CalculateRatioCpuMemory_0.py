...
client_maxmincpu = DataStoreClient("postgres", ConfigDB_Calc_MaxMinCPU_0)
...
client_mediancpu = DataStoreClient("postgres", ConfigDB_Calc_MedianCPU_0)
...
client_avgcpu = DataStoreClient("postgres", ConfigDB_Calc_AverageCPU_0)
...
# task_events
client_task = DataStoreClient("postgres", ConfigDB_TaskEvent_0)
