...
import ConfigDB_Calc_MaxMinCPU_2
import ConfigDB_Calc_AverageCPU_2
import ConfigDB_Calc_MedianCPU_2

import math

##################################################################

client_maxmincpu = DataStoreClient("postgres", ConfigDB_Calc_MaxMinCPU_2)
...
client_mediancpu = DataStoreClient("postgres", ConfigDB_Calc_MedianCPU_2)
...
client_avgcpu = DataStoreClient("postgres", ConfigDB_Calc_AverageCPU_2)
...
# task_events
client_task = DataStoreClient("postgres", ConfigDB_TaskEvent_2)
