...
import ConfigDB_Calc_MaxMinCPU_4
import ConfigDB_Calc_AverageCPU_4
import ConfigDB_Calc_MedianCPU_4

import math

##################################################################

client_maxmincpu = DataStoreClient("mongodb", ConfigDB_Calc_MaxMinCPU_4)
...
client_mediancpu = DataStoreClient("mongodb", ConfigDB_Calc_MedianCPU_4)
...
client_avgcpu = DataStoreClient("mongodb", ConfigDB_Calc_AverageCPU_4)
...
# task_events
client_task = DataStoreClient("mongodb", ConfigDB_TaskEvent_4)
