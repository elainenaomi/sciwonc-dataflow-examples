...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_1:1.0 -N ID0000007 -R condorpool  -L example_workflow -T 2017-01-18T03:44:18+00:00 ./wikiflow-longestsession_1-1.0 
job_ec=$?
set -e
