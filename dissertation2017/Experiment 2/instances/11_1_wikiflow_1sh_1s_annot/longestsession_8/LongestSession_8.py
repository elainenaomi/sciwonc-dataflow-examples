...
import ConfigDB_Longest_8
import pprint
import datetime

# connector and config
client = DataStoreClient("mongodb", ConfigDB_Longest_8)
config = ConfigDB_Longest_8
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_Longest_8)
