...
import ConfigDB_SessionCompute_4
import pprint

# connector and config
client = DataStoreClient("mongodb", ConfigDB_SessionCompute_4)
config = ConfigDB_SessionCompute_4
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_SessionCompute_4)
