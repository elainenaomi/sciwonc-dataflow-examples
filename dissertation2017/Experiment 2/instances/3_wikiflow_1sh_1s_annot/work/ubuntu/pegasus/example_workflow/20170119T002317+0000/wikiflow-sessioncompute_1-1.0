...
import ConfigDB_SessionCompute_1
import pprint

# connector and config
client = DataStoreClient("postgres", ConfigDB_SessionCompute_1)
config = ConfigDB_SessionCompute_1
...
if(dataList):
    for i in dataList:
        ...
        if contributor_username:
            ...
            print "saving"
            clientOutput = DataStoreClient("postgres", ConfigDB_SessionCompute_1)
