...
import ConfigDB_Longest_0
import pprint
import datetime

# connector and config
client = DataStoreClient("postgres", ConfigDB_Longest_0)
config = ConfigDB_Longest_0
...
if(dataList):
    ...
    clientOutput = DataStoreClient("postgres", ConfigDB_Longest_0)
