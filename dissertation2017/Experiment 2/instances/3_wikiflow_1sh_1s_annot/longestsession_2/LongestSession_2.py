...
import ConfigDB_Longest_2
import pprint
import datetime

# connector and config
client = DataStoreClient("postgres", ConfigDB_Longest_2)
config = ConfigDB_Longest_2
...
if(dataList):
    ...
    clientOutput = DataStoreClient("postgres", ConfigDB_Longest_2)
