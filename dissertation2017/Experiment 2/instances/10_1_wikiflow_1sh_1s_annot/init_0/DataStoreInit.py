...
contributors_col.create_index([("_id", pymongo.HASHED)])
user_sessions_col.create_index([("_id", pymongo.HASHED)])

#c.admin.command('shardCollection', dbname+'.'+contributors, key={'_id': "hashed"})
#c.admin.command('shardCollection', dbname+'.'+user_sessions, key={'_id': "hashed"})
