...
import ConfigDB_Longest_4
import pprint
import datetime

# connector and config
client = DataStoreClient("mongodb", ConfigDB_Longest_4)
config = ConfigDB_Longest_4
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_Longest_4)
