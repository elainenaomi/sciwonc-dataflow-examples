...
import ConfigDB_Longest_3
import pprint
import datetime

# connector and config
client = DataStoreClient("mongodb", ConfigDB_Longest_3)
config = ConfigDB_Longest_3
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_Longest_3)
