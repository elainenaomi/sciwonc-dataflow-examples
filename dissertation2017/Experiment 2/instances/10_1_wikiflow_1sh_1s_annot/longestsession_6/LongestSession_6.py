...
import ConfigDB_Longest_6
import pprint
import datetime

# connector and config
client = DataStoreClient("mongodb", ConfigDB_Longest_6)
config = ConfigDB_Longest_6
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_Longest_6)
