...
import ConfigDB_SessionCompute_5
import pprint

# connector and config
client = DataStoreClient("mongodb", ConfigDB_SessionCompute_5)
config = ConfigDB_SessionCompute_5
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_SessionCompute_5)
