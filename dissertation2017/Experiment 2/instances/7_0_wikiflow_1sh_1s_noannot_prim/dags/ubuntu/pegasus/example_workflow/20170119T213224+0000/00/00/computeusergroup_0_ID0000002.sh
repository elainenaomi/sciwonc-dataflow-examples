...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::computeusergroup_0:1.0 -N ID0000002 -R condorpool  -s ConfigDB_SessionCompute_0.py=ConfigDB_SessionCompute_0.py -L example_workflow -T 2017-01-19T21:32:23+00:00 ./wikiflow-computeusergroup_0-1.0 
job_ec=$?
set -e
