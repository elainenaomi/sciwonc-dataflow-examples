...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_0:1.0 -N ID0000003 -R condorpool  -L example_workflow -T 2017-01-19T12:36:09+00:00 ./wikiflow-sessioncompute_0-1.0 
job_ec=$?
set -e
