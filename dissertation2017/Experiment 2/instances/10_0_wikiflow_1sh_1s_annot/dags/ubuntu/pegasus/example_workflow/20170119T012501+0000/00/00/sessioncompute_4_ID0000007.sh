...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_4:1.0 -N ID0000007 -R condorpool  -L example_workflow -T 2017-01-19T01:25:00+00:00 ./wikiflow-sessioncompute_4-1.0 
job_ec=$?
set -e
