...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_7:1.0 -N ID0000010 -R condorpool  -L example_workflow -T 2017-01-18T18:49:39+00:00 ./wikiflow-sessioncompute_7-1.0 
job_ec=$?
set -e
