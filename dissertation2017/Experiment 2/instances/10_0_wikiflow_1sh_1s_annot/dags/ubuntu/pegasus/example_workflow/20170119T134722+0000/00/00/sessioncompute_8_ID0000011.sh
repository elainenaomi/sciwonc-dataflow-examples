...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_8:1.0 -N ID0000011 -R condorpool  -L example_workflow -T 2017-01-19T13:47:21+00:00 ./wikiflow-sessioncompute_8-1.0 
job_ec=$?
set -e
