...
import ConfigDB_SessionCompute_6
import pprint

# connector and config
client = DataStoreClient("mongodb", ConfigDB_SessionCompute_6)
config = ConfigDB_SessionCompute_6
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_SessionCompute_6)
