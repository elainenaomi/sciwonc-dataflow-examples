...
import ConfigDB_Longest_5
import pprint
import datetime

# connector and config
client = DataStoreClient("mongodb", ConfigDB_Longest_5)
config = ConfigDB_Longest_5
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_Longest_5)
