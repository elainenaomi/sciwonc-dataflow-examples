...
import ConfigDB_SessionCompute_7
import pprint

# connector and config
client = DataStoreClient("mongodb", ConfigDB_SessionCompute_7)
config = ConfigDB_SessionCompute_7
...
if(dataList):
    ...
    clientOutput = DataStoreClient("mongodb", ConfigDB_SessionCompute_7)
