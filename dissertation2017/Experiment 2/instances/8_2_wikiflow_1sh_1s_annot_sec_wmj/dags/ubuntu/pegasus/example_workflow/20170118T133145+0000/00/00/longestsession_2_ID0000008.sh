...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_2:1.0 -N ID0000008 -R condorpool  -L example_workflow -T 2017-01-18T13:31:45+00:00 ./wikiflow-longestsession_2-1.0 
job_ec=$?
set -e
