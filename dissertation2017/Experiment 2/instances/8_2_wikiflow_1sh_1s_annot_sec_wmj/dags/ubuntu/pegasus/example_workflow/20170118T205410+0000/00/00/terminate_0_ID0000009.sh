...
/bin/chmod +x wikiflow-terminate_0-1.0 

echo -e "\n############################# executing the user tasks #############################"  1>&2
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::terminate_0:1.0 -N ID0000009 -R condorpool  -L example_workflow -T 2017-01-18T20:54:09+00:00 ./wikiflow-terminate_0-1.0 
job_ec=$?
set -e
