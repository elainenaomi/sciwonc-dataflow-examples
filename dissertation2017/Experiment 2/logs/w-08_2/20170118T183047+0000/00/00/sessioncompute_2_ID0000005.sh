...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_2:1.0 -N ID0000005 -R condorpool  -L example_workflow -T 2017-01-18T18:30:47+00:00 ./wikiflow-sessioncompute_2-1.0 
job_ec=$?
set -e
