...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_6:1.0 -N ID0000018 -R condorpool  -L example_workflow -T 2017-01-24T03:02:11+00:00 ./wikiflow-longestsession_6-1.0 
job_ec=$?
set -e
