...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_2:1.0 -N ID0000014 -R condorpool  -L example_workflow -T 2017-01-26T18:01:58+00:00 ./wikiflow-longestsession_2-1.0 
job_ec=$?
set -e
