...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_8:1.0 -N ID0000020 -R condorpool  -L example_workflow -T 2017-01-25T20:07:02+00:00 ./wikiflow-longestsession_8-1.0 
job_ec=$?
set -e
