...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_5:1.0 -N ID0000008 -R condorpool  -L example_workflow -T 2017-01-24T23:15:29+00:00 ./wikiflow-sessioncompute_5-1.0 
job_ec=$?
set -e
