        ...
        for line in f:
            ...
            # any(substring in string for substring in substring_list)
                ...
                if count < 13:
                    ...
                    stats_workflow_jobs[workflow][execution][job]["total bytes sent"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["total bytes received"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["cpu request"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["cpu allocated"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["disk(KB) usage"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["disk(KB) request"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["disk(KB) allocated"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["memory(MB) usage"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["memory(MB) request"] = "0"
                    stats_workflow_jobs[workflow][execution][job]["memory(MB) allocated"] = "0"
