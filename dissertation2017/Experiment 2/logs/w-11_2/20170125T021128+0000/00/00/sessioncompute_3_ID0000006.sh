...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_3:1.0 -N ID0000006 -R condorpool  -L example_workflow -T 2017-01-25T02:11:27+00:00 ./wikiflow-sessioncompute_3-1.0 
job_ec=$?
set -e
