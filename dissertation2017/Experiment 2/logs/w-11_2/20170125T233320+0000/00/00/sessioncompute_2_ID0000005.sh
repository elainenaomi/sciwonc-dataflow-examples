...
/bin/chmod +x wikiflow-sessioncompute_2-1.0 

echo -e "\n############################# executing the user tasks #############################"  1>&2
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_2:1.0 -N ID0000005 -R condorpool  -L example_workflow -T 2017-01-25T23:33:19+00:00 ./wikiflow-sessioncompute_2-1.0 
job_ec=$?
set -e
