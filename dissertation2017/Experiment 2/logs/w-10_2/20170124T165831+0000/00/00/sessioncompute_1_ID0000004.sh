...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::sessioncompute_1:1.0 -N ID0000004 -R condorpool  -L example_workflow -T 2017-01-24T16:58:31+00:00 ./wikiflow-sessioncompute_1-1.0 
job_ec=$?
set -e
