...
# execute the tasks
set +e
pegasus-kickstart -n wikiflow::longestsession_5:1.0 -N ID0000017 -R condorpool  -L example_workflow -T 2017-01-25T16:16:11+00:00 ./wikiflow-longestsession_5-1.0 
job_ec=$?
set -e
