#!/usr/bin/python
"""
Gera o tempo de execucao das atividades replicas considerando o tempo mais cedo e o tempo mais tarde obtido da lista de replicas
"""
import psycopg2
import sys
import pprint
...
def main():
    conn_string = "host='localhost' dbname='wiki_s' user='postgres' password='enw1989'"
