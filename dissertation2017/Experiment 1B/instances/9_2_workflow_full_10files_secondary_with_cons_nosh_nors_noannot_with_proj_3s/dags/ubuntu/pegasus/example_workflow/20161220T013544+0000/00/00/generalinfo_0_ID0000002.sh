...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::generalinfo_0:1.0 -N ID0000002 -R condorpool  -L example_workflow -T 2016-12-20T01:35:44+00:00 ./example_workflow-generalinfo_0-1.0 
job_ec=$?
set -e
