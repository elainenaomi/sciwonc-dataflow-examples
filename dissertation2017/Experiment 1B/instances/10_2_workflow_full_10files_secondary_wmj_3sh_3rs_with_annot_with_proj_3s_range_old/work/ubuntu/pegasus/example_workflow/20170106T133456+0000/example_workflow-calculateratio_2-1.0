...
client_statscpumemory = DataStoreClient("mongodb", ConfigDB_Calc_StatsCPUMemory_2)
...
client_taskinfo = DataStoreClient("mongodb", ConfigDB_Calc_TEInfo_2)
...
client_task = DataStoreClient("mongodb", ConfigDB_Calc_TaskEvent_2)
