...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::statscpumemory_0:1.0 -N ID0000003 -R condorpool  -L example_workflow -T 2017-01-06T13:34:55+00:00 ./example_workflow-statscpumemory_0-1.0 
job_ec=$?
set -e
