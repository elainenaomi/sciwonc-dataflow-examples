...
client_statscpumemory = DataStoreClient("mongodb", ConfigDB_Calc_StatsCPUMemory_1)
...
client_taskinfo = DataStoreClient("mongodb", ConfigDB_Calc_TEInfo_1)
...
client_task = DataStoreClient("mongodb", ConfigDB_Calc_TaskEvent_1)
