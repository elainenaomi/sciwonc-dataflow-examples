...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratioevent_2:1.0 -N ID0000014 -R condorpool  -L example_workflow -T 2016-12-02T21:49:10+00:00 ./example_workflow-averageratioevent_2-1.0 
job_ec=$?
set -e
