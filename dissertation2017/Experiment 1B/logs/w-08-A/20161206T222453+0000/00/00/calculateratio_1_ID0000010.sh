...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_1:1.0 -N ID0000010 -R condorpool  -L example_workflow -T 2016-12-06T22:24:53+00:00 ./example_workflow-calculateratio_1-1.0 
job_ec=$?
set -e
