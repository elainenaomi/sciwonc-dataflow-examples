...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_0:1.0 -N ID0000009 -R condorpool  -L example_workflow -T 2017-01-09T20:15:21+00:00 ./example_workflow-calculateratio_0-1.0 
job_ec=$?
set -e
