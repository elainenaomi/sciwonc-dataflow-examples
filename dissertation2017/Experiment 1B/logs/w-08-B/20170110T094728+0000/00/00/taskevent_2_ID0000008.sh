...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::taskevent_2:1.0 -N ID0000008 -R condorpool  -L example_workflow -T 2017-01-10T09:47:28+00:00 ./example_workflow-taskevent_2-1.0 
job_ec=$?
set -e
