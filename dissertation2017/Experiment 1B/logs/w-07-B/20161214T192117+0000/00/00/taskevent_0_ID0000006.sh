...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::taskevent_0:1.0 -N ID0000006 -R condorpool  -L example_workflow -T 2016-12-14T19:21:16+00:00 ./example_workflow-taskevent_0-1.0 
job_ec=$?
set -e
