...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::terminate_0:1.0 -N ID0000010 -R condorpool  -L example_workflow -T 2016-11-08T17:18:34+00:00 ./example_workflow-terminate_0-1.0 
job_ec=$?
set -e
