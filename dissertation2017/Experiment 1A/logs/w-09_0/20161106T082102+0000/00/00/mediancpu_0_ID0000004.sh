...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::mediancpu_0:1.0 -N ID0000004 -R condorpool  -L example_workflow -T 2016-11-06T08:21:01+00:00 ./example_workflow-mediancpu_0-1.0 
job_ec=$?
set -e
