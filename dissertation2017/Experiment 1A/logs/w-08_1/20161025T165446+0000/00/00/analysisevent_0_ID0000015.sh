...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::analysisevent_0:1.0 -N ID0000015 -R condorpool  -L example_workflow -T 2016-10-25T16:54:46+00:00 ./example_workflow-analysisevent_0-1.0 
job_ec=$?
set -e
