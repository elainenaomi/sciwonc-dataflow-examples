...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratioevent_0:1.0 -N ID0000024 -R condorpool  -L example_workflow -T 2016-11-07T09:00:01+00:00 ./example_workflow-averageratioevent_0-1.0 
job_ec=$?
set -e
