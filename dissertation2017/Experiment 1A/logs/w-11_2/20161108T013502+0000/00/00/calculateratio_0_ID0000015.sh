...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_0:1.0 -N ID0000015 -R condorpool  -L example_workflow -T 2016-11-08T01:35:02+00:00 ./example_workflow-calculateratio_0-1.0 
job_ec=$?
set -e
