...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::taskevent_2:1.0 -N ID0000008 -R condorpool  -L example_workflow -T 2016-10-26T07:50:01+00:00 ./example_workflow-taskevent_2-1.0 
job_ec=$?
set -e
