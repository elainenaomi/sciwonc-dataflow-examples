...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratioevent_0:1.0 -N ID0000012 -R condorpool  -L example_workflow -T 2016-10-26T06:40:01+00:00 ./example_workflow-averageratioevent_0-1.0 
job_ec=$?
set -e
