...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratioevent_1:1.0 -N ID0000013 -R condorpool  -L example_workflow -T 2016-10-25T04:30:02+00:00 ./example_workflow-averageratioevent_1-1.0 
job_ec=$?
set -e
