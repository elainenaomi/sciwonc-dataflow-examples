...
client = DataStoreClient("mongodb", ConfigDB_Analysis_AverageEvent_0)
...
if(data):
    ...
    while True:
        ...
        task_types = {}
        task_types["cpu"] = doc['total cpu task']
        task_types["memory"] = doc['total memory task']
        task_types["balanced"] = doc['total balanced task']
