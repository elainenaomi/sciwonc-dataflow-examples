...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::statscpumemory_0:1.0 -N ID0000003 -R condorpool  -L example_workflow -T 2016-11-08T00:40:01+00:00 ./example_workflow-statscpumemory_0-1.0 
job_ec=$?
set -e
