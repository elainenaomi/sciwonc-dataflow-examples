...
##################################################################
import ConfigDB_Calc_StatsCPUMemory_7
client_statscpumemory = DataStoreClient("mongodb", ConfigDB_Calc_StatsCPUMemory_7)
...
##################################################################
import ConfigDB_Calc_TEInfo_7
client_taskinfo = DataStoreClient("mongodb", ConfigDB_Calc_TEInfo_7)
...
if(eventList):
    for index in eventList:
        ...
        event_type = index[ConfigDB_Calc_TEInfo_7.COLUMN]
        while True:
            doc = index['data'].next()
            if doc is None:
                break;
...
import ConfigDB_Calc_TaskEvent_7
client_task = DataStoreClient("mongodb", ConfigDB_Calc_TaskEvent_7)
