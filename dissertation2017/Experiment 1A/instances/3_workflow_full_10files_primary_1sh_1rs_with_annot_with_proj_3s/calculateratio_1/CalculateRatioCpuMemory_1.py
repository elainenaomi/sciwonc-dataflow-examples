...
##################################################################
import ConfigDB_Calc_StatsCPUMemory_1
client_statscpumemory = DataStoreClient("postgres", ConfigDB_Calc_StatsCPUMemory_1)
...
##################################################################
import ConfigDB_Calc_TEInfo_1
client_taskinfo = DataStoreClient("postgres", ConfigDB_Calc_TEInfo_1)
...
if(eventList):
    for index in eventList:
        ...
        event_type = index[ConfigDB_Calc_TEInfo_1.COLUMN]
        while True:
            doc = index['data'].next()
            if doc is None:
                break;
...
import ConfigDB_Calc_TaskEvent_1
client_task = DataStoreClient("postgres", ConfigDB_Calc_TaskEvent_1)
