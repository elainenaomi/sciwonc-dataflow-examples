...
##################################################################
import ConfigDB_Calc_StatsCPUMemory_6
client_statscpumemory = DataStoreClient("mongodb", ConfigDB_Calc_StatsCPUMemory_6)
...
##################################################################
import ConfigDB_Calc_TEInfo_6
client_taskinfo = DataStoreClient("mongodb", ConfigDB_Calc_TEInfo_6)
...
if(eventList):
    for index in eventList:
        ...
        event_type = index[ConfigDB_Calc_TEInfo_6.COLUMN]
        while True:
            doc = index['data'].next()
            if doc is None:
                break;
...
import ConfigDB_Calc_TaskEvent_6
client_task = DataStoreClient("mongodb", ConfigDB_Calc_TaskEvent_6)
