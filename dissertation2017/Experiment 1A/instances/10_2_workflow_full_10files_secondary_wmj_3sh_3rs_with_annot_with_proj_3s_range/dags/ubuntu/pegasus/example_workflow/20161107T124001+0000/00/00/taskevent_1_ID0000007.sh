...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::taskevent_1:1.0 -N ID0000007 -R condorpool  -L example_workflow -T 2016-11-07T12:40:01+00:00 ./example_workflow-taskevent_1-1.0 
job_ec=$?
set -e
