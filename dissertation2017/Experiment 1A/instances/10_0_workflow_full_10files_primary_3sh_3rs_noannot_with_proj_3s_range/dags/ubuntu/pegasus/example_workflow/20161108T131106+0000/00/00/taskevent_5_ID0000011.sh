...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::taskevent_5:1.0 -N ID0000011 -R condorpool  -L example_workflow -T 2016-11-08T13:11:06+00:00 ./example_workflow-taskevent_5-1.0 
job_ec=$?
set -e
