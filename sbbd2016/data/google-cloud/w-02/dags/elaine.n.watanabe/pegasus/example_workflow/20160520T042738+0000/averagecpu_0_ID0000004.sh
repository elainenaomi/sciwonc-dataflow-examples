...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averagecpu_0:1.0 -N ID0000004 -R condorpool  -L example_workflow -T 2016-05-20T04:27:38+00:00 ./example_workflow-averagecpu_0-1.0 
job_ec=$?
set -e
