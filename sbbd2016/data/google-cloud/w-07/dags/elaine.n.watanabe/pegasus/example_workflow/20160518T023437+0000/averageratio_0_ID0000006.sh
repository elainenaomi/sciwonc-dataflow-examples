...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratio_0:1.0 -N ID0000006 -R condorpool  -L example_workflow -T 2016-05-18T02:34:37+00:00 ./example_workflow-averageratio_0-1.0 
job_ec=$?
set -e
