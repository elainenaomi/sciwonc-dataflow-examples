...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::maxminratio_0:1.0 -N ID0000007 -R condorpool  -L example_workflow -T 2016-05-15T13:42:12+00:00 ./example_workflow-maxminratio_0-1.0 
job_ec=$?
set -e
