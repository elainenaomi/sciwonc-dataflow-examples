...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_1:1.0 -N ID0000006 -R condorpool  -L example_workflow -T 2016-05-23T03:08:41+00:00 ./example_workflow-calculateratio_1-1.0 
job_ec=$?
set -e
