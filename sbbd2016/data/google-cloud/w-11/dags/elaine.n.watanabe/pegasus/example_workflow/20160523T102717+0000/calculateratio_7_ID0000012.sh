...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_7:1.0 -N ID0000012 -R condorpool  -L example_workflow -T 2016-05-23T10:27:16+00:00 ./example_workflow-calculateratio_7-1.0 
job_ec=$?
set -e
