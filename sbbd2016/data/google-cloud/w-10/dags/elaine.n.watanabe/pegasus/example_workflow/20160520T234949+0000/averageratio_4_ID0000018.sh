...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratio_4:1.0 -N ID0000018 -R condorpool  -L example_workflow -T 2016-05-20T23:49:49+00:00 ./example_workflow-averageratio_4-1.0 
job_ec=$?
set -e
