...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_6:1.0 -N ID0000011 -R condorpool  -L example_workflow -T 2016-05-21T03:16:22+00:00 ./example_workflow-calculateratio_6-1.0 
job_ec=$?
set -e
