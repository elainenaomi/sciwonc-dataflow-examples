...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_0:1.0 -N ID0000005 -R condorpool  -L example_workflow -T 2016-05-12T11:11:05+00:00 ./example_workflow-calculateratio_0-1.0 
job_ec=$?
set -e
