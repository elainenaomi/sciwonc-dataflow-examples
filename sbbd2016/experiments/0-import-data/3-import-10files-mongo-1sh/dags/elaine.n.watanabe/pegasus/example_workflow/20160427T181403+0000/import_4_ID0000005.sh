...
/bin/chmod +x example_workflow-import_4-1.0 

echo -e "\n############################# executing the user tasks #############################"  1>&2
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::import_4:1.0 -N ID0000005 -R condorpool  -L example_workflow -T 2016-04-27T18:14:01+00:00 ./example_workflow-import_4-1.0 
job_ec=$?
set -e
