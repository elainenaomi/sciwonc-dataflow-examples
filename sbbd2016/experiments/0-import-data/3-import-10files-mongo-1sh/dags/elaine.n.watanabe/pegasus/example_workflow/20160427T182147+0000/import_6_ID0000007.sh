...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::import_6:1.0 -N ID0000007 -R condorpool  -L example_workflow -T 2016-04-27T18:21:44+00:00 ./example_workflow-import_6-1.0 
job_ec=$?
set -e
