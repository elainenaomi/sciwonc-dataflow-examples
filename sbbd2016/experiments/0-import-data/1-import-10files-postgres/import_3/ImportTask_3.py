...
import ConfigCSVGZ_ImportTask_3
import ConfigDB_ImportTask_3

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_3)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_3)
