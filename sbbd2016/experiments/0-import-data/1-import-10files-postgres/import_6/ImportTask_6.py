...
import ConfigCSVGZ_ImportTask_6
import ConfigDB_ImportTask_6

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_6)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_6)
