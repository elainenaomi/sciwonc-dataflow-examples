...
import ConfigCSVGZ_ImportTask_9
import ConfigDB_ImportTask_9

# connector and config
clientCSV = DataStoreClient("csv.gz", ConfigCSVGZ_ImportTask_9)
...
def main():
	...
	if(data):
		for c in data:
			...
			clientOutput = DataStoreClient("postgres", ConfigDB_ImportTask_9)
