...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::import_0:1.0 -N ID0000001 -R condorpool  -L example_workflow -T 2016-04-29T02:46:22+00:00 ./example_workflow-import_0-1.0 
job_ec=$?
set -e
