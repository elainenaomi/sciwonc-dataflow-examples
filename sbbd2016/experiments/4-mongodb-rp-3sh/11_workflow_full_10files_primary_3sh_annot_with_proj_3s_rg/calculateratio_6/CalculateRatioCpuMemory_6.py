...
import ConfigDB_TaskEvent_6
import ConfigDB_Calc_MaxMinCPU_6
import ConfigDB_Calc_AverageCPU_6
import ConfigDB_Calc_MedianCPU_6

import math

##################################################################

client_maxmincpu = DataStoreClient("mongodb", ConfigDB_Calc_MaxMinCPU_6)
...
client_mediancpu = DataStoreClient("mongodb", ConfigDB_Calc_MedianCPU_6)
...
client_avgcpu = DataStoreClient("mongodb", ConfigDB_Calc_AverageCPU_6)
...
# task_events
client_task = DataStoreClient("mongodb", ConfigDB_TaskEvent_6)
