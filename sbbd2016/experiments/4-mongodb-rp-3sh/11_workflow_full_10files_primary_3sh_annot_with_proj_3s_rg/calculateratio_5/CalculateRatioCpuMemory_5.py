...
import ConfigDB_TaskEvent_5
import ConfigDB_Calc_MaxMinCPU_5
import ConfigDB_Calc_AverageCPU_5
import ConfigDB_Calc_MedianCPU_5

import math

##################################################################

client_maxmincpu = DataStoreClient("mongodb", ConfigDB_Calc_MaxMinCPU_5)
...
client_mediancpu = DataStoreClient("mongodb", ConfigDB_Calc_MedianCPU_5)
...
client_avgcpu = DataStoreClient("mongodb", ConfigDB_Calc_AverageCPU_5)
...
# task_events
client_task = DataStoreClient("mongodb", ConfigDB_TaskEvent_5)
