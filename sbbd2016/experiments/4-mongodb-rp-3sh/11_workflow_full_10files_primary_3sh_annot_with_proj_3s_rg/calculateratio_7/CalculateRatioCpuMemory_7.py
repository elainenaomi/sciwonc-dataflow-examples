...
import ConfigDB_TaskEvent_7
import ConfigDB_Calc_MaxMinCPU_7
import ConfigDB_Calc_AverageCPU_7
import ConfigDB_Calc_MedianCPU_7

import math

##################################################################

client_maxmincpu = DataStoreClient("mongodb", ConfigDB_Calc_MaxMinCPU_7)
...
client_mediancpu = DataStoreClient("mongodb", ConfigDB_Calc_MedianCPU_7)
...
client_avgcpu = DataStoreClient("mongodb", ConfigDB_Calc_AverageCPU_7)
...
# task_events
client_task = DataStoreClient("mongodb", ConfigDB_TaskEvent_7)
