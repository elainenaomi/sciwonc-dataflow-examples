...
client_maxmincpu = DataStoreClient("mongodb", ConfigDB_Calc_MaxMinCPU_1)
...
client_mediancpu = DataStoreClient("mongodb", ConfigDB_Calc_MedianCPU_1)
...
client_avgcpu = DataStoreClient("mongodb", ConfigDB_Calc_AverageCPU_1)
...
# task_events
client_task = DataStoreClient("mongodb", ConfigDB_TaskEvent_1)
