...
import ConfigDB_Calc_MaxMinCPU_1
import ConfigDB_Calc_AverageCPU_1
import ConfigDB_Calc_MedianCPU_1

import math

##################################################################

client_maxmincpu = DataStoreClient("postgres", ConfigDB_Calc_MaxMinCPU_1)
...
client_mediancpu = DataStoreClient("postgres", ConfigDB_Calc_MedianCPU_1)
...
client_avgcpu = DataStoreClient("postgres", ConfigDB_Calc_AverageCPU_1)
...
# task_events
client_task = DataStoreClient("postgres", ConfigDB_TaskEvent_1)
