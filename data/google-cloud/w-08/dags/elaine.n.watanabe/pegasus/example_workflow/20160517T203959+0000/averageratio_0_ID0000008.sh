...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratio_0:1.0 -N ID0000008 -R condorpool  -L example_workflow -T 2016-05-17T20:39:59+00:00 ./example_workflow-averageratio_0-1.0 
job_ec=$?
set -e
