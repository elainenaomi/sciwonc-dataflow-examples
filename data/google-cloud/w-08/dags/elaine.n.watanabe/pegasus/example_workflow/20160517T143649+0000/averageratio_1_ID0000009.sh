...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratio_1:1.0 -N ID0000009 -R condorpool  -L example_workflow -T 2016-05-17T14:36:48+00:00 ./example_workflow-averageratio_1-1.0 
job_ec=$?
set -e
