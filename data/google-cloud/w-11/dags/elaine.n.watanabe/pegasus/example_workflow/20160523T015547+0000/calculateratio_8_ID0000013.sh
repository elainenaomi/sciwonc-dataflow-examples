...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::calculateratio_8:1.0 -N ID0000013 -R condorpool  -L example_workflow -T 2016-05-23T01:55:46+00:00 ./example_workflow-calculateratio_8-1.0 
job_ec=$?
set -e
