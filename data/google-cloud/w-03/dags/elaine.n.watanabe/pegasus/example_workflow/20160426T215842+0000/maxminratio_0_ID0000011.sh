...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::maxminratio_0:1.0 -N ID0000011 -R condorpool  -L example_workflow -T 2016-04-26T21:58:42+00:00 ./example_workflow-maxminratio_0-1.0 
job_ec=$?
set -e
