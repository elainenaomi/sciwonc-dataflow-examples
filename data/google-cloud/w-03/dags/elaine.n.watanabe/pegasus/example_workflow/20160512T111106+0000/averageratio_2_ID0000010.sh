...
# execute the tasks
set +e
pegasus-kickstart -n example_workflow::averageratio_2:1.0 -N ID0000010 -R condorpool  -L example_workflow -T 2016-05-12T11:11:05+00:00 ./example_workflow-averageratio_2-1.0 
job_ec=$?
set -e
